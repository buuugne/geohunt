...
namespace psi25_project.Migrations
{
    ...
    [Migration("20260322213242_AddLeaderboard")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("psi25_project.Models.Leaderboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("psi25_project.Models.MultiplayerGame", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double?>("RoundLatitude")
                        .HasColumnType("double precision");

                    b.Property<double?>("RoundLongitude")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("psi25_project.Models.MultiplayerPlayer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double?>("LastGuessLatitude")
                        .HasColumnType("double precision");

                    b.Property<double?>("LastGuessLongitude")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("psi25_project.Models.PlayerRanking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("psi25_project.Models.MultiplayerPlayer", b =>
                {
                    b.HasOne("psi25_project.Models.MultiplayerGame", "Game")
                        .WithMany("Players")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("psi25_project.Models.Player", "Player")
                        .WithMany()
            ...
            modelBuilder.Entity("psi25_project.Models.PlayerRanking", b =>
                {
                    b.HasOne("psi25_project.Models.Leaderboard", "Leaderboard")
                        .WithMany("Rankings")
